module Admin
  class TillsController < BaseController
    ...
    def destroy
      if @till.destroy
        redirect_to admin_tills_path, notice: "Till was successfully destroyed.", status: :see_other
      else
        redirect_to admin_tills_path, notice: @till.errors.full_messages.to_sentence, status: :see_other
      end
    end
